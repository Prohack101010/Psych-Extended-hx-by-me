...
class Controls extends FlxActionSet
{
	...
	public var _ui_up = new FlxActionDigital(Action.UI_UP);
	public var _ui_left = new FlxActionDigital(Action.UI_LEFT);
	public var _ui_right = new FlxActionDigital(Action.UI_RIGHT);
	public var _ui_down = new FlxActionDigital(Action.UI_DOWN);
	public var _ui_upP = new FlxActionDigital(Action.UI_UP_P);
	public var _ui_leftP = new FlxActionDigital(Action.UI_LEFT_P);
	public var _ui_rightP = new FlxActionDigital(Action.UI_RIGHT_P);
	public var _ui_downP = new FlxActionDigital(Action.UI_DOWN_P);
	public var _ui_upR = new FlxActionDigital(Action.UI_UP_R);
	public var _ui_leftR = new FlxActionDigital(Action.UI_LEFT_R);
	public var _ui_rightR = new FlxActionDigital(Action.UI_RIGHT_R);
	public var _ui_downR = new FlxActionDigital(Action.UI_DOWN_R);
	public var _note_up = new FlxActionDigital(Action.NOTE_UP);
	public var _note_left = new FlxActionDigital(Action.NOTE_LEFT);
	public var _note_right = new FlxActionDigital(Action.NOTE_RIGHT);
	public var _note_down = new FlxActionDigital(Action.NOTE_DOWN);
	public var _note_upP = new FlxActionDigital(Action.NOTE_UP_P);
	public var _note_leftP = new FlxActionDigital(Action.NOTE_LEFT_P);
	public var _note_rightP = new FlxActionDigital(Action.NOTE_RIGHT_P);
	public var _note_downP = new FlxActionDigital(Action.NOTE_DOWN_P);
	public var _note_upR = new FlxActionDigital(Action.NOTE_UP_R);
	public var _note_leftR = new FlxActionDigital(Action.NOTE_LEFT_R);
	public var _note_rightR = new FlxActionDigital(Action.NOTE_RIGHT_R);
	public var _note_downR = new FlxActionDigital(Action.NOTE_DOWN_R);
	public var _accept = new FlxActionDigital(Action.ACCEPT);
	public var _back = new FlxActionDigital(Action.BACK);
	public var _pause = new FlxActionDigital(Action.PAUSE);
	public var _reset = new FlxActionDigital(Action.RESET);
